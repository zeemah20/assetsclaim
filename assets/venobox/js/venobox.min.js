    ...
    function r() {
      b.html(q),
        ...
        e(".figlio")
          ...
          .css("background", d),
        n(Q, H),
        f.animate({ opacity: "1" }, "slow", I(f, v, b));
    }
    function n() {
      (Q = f.outerHeight()),
        (H = e(window).height()),
        H > Q + 30
          ? ((_ = (H - Q) / 2), f.css("margin-top", _), f.css("margin-bottom", _))
          : (f.css("margin-top", "30px"), f.css("margin-bottom", "30px")),
        J(f, v, b);
    }
    var l,
      d,
              ...
              void i.on("click", function (r) {
                function _() {
                  (P = i.data("gall")),
                    ...
                    w.length > 1 && B === !0
                      ? (v.html(w.index(i) + 1 + " / " + w.length), v.show())
                      : v.hide(),
                    (D = w.eq(w.index(i) + 1)),
                    (E = w.eq(w.index(i) - 1)),
                    "" !== q ? b.show() : b.hide(),
                    w.length > 1 && y === !0
                      ? ((T = !0),
                        (A = !0),
                        D.length < 1 && (D = w.eq(0)),
                        w.index(i) < 1 && (E = w.eq(w.index(w.length))))
                      : (D.length > 0
                          ? (e(".vbox-next").css("display", "block"), (T = !0))
                          : (e(".vbox-next").css("display", "none"), (T = !1)),
                        w.index(i) > 0
                          ? (e(".vbox-prev").css("display", "block"), (A = !0))
                          : (e(".vbox-prev").css("display", "none"), (A = !1)));
                }
                function H(e) {
                  27 === e.keyCode && Q();
                }
                ...
                if (void 0 == I || I) {
                  ...
                  (F += "</div>"),
                    ...
                    (vbheader =
                      '<div class="vbox-title"></div><div class="vbox-num">0/0</div><div class="vbox-close">&times;</div>'),
                    (p =
                    ...
                    ).css("background-color", n.spinColor),
                    (z = e(".vbox-overlay")),
                    (k = e(".vbox-container")),
                    (f = e(".vbox-content")),
                    (v = e(".vbox-num")),
                  ...
                  return (
                    ...
                    e(K).click(function (a) {
                      (e(a.target).is(".vbox-overlay") ||
                        e(a.target).is(".vbox-content") ||
                        e(a.target).is(".vbox-close") ||
                        e(a.target).is(".vbox-preloader")) &&
                        Q();
                    }),
                    e("body").keydown(H),
                    !1
